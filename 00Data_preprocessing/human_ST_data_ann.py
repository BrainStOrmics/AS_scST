...
sc <- readRDS("。/sc_v2.RDS")
sc@meta.data$celltype <- str_replace(sc@meta.data$celltype,"NK_cell/T_cell","NKT")
sc@meta.data$celltype <- as.character(sc@meta.data$celltype)
